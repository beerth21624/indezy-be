...
router.get("/details", machineStatusSegmentController_1.default.getMachineStatusDetails);
router.get("/machine/:machineId", machineStatusSegmentController_1.default.getStatusSegmentsByMachine);
router.get("/machine/:machineId/details", machineStatusSegmentController_1.default.getSingleMachineStatusDetails);

...
exports.powerMetricController = {
    ...
    createPowerMetric(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newPowerMetric = yield prisma.powerMetric.create({
                    data: {
    ...
    getAllPowerMetrics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const powerMetrics = yield prisma.powerMetric.findMany({
                    include: { machine: true },
                });
    ...
    getPowerMetricById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const powerMetric = yield prisma.powerMetric.findUnique({
                    where: { id },
                    include: { machine: true },
                });
                if (powerMetric) {
    ...
    // Update Power Metric
    updatePowerMetric(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const updateData = req.body;
                const updatedPowerMetric = yield prisma.powerMetric.update({
                    where: { id },
                    data: updateData,
                    include: { machine: true },
                });
    ...
    // Delete Power Metric
    deletePowerMetric(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const result = yield prisma.powerMetric.delete({
                    where: { id },
                });
                if (result) {
    ...
    getPowerMetricsByMachine(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    getPowerMetricsByDateRange(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { machineId } = req.params;
    ...
    calculateDailyPowerConsumption(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    getLatestPowerMetricForAllMachines(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const formattedResults = machines.map((machine) => (Object.assign({ name: machine.name }, machine.powerMetrics[0])));
    ...
    getFilteredPowerMetrics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { productionLineId, machineId, startDate, endDate, mockSize } = req.query;
                // Check if mock data is requested
                if (mockSize) {
                    const size = parseInt(mockSize, 10);
                    const mockData = Array.from({ length: size }, (_, i) => (0, generateMockPowerMetric_1.generateMockPowerMetric)(i));
                ...
                res.status(500).json({
                    error: "Unable to fetch Power Metrics based on the specified conditions",
                });
            }
        });
    },
    downloadCSVReport(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (mockSize) {
                    // Generate mock data
                    const size = parseInt(mockSize, 10);
                    powerMetrics = Array.from({ length: size }, (_, i) => (0, generateMockPowerMetric_1.generateMockPowerMetric)(i));
                }
                else {
                    // Fetch real data from the database
                    powerMetrics = yield prisma.powerMetric.findMany({
                        where: {
                            machineId: machineId,
                            timestamp: {
                                gte: new Date(startDate),
                ...
                const csvData = powerMetrics.map((metric) => ({
                    ...
                    productionLine: "Mock Production Line",
                ...
                res.setHeader("Content-Disposition", "attachment; filename=power_metrics_report.csv");
                // Send CSV file
    ...
    downloadPDFReport(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (machine) {
                    doc.text(`Company: ${((_c = (_b = (_a = machine.productionLine) === null || _a === void 0 ? void 0 : _a.factory) === null || _b === void 0 ? void 0 : _b.company) === null || _c === void 0 ? void 0 : _c.name) || "Mock Company"}`);
                    doc.text(`Factory: ${((_e = (_d = machine.productionLine) === null || _d === void 0 ? void 0 : _d.factory) === null || _e === void 0 ? void 0 : _e.name) || "Mock Factory"}`);
                    doc.text(`Production Line: ${((_f = machine.productionLine) === null || _f === void 0 ? void 0 : _f.name) || "Mock Production Line"}`);
